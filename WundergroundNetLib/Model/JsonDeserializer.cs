            ...
            WundergroundWeatherData weatherData = await Task.Run(() =>
            {
                weatherData = new WundergroundWeatherData()
                {
                    ...
                    CurrentConditions = new CurrentConditions()
                    {
                        ...
                        SimpleDescription = (string)jObject["current_observation"]["weather"], // weather : "Rain"
                    ...
                    FourDayForecast = new List<Forecast>()
                    {
                        new Forecast()
                        {
                            ...
                            ObservationTime = new DateTime((int)jObject["forecast"]["simpleforecast"]["forecastday"][0]["date"]["year"],(int)jObject["forecast"]["simpleforecast"]["forecastday"][0]["date"]["month"],(int)jObject["forecast"]["simpleforecast"]["forecastday"][0]["date"]["day"]),  // simpleforecast / forecastday / date / year, month, day
                        ...
                        new Forecast()
                        {
                            ...
                            ObservationTime = new DateTime((int)jObject["forecast"]["simpleforecast"]["forecastday"][1]["date"]["year"],(int)jObject["forecast"]["simpleforecast"]["forecastday"][1]["date"]["month"],(int)jObject["forecast"]["simpleforecast"]["forecastday"][1]["date"]["day"]),  // simpleforecast / forecastday / date / year, month, day
                        ...
                        new Forecast()
                        {
                            ...
                            ObservationTime = new DateTime((int)jObject["forecast"]["simpleforecast"]["forecastday"][2]["date"]["year"],(int)jObject["forecast"]["simpleforecast"]["forecastday"][2]["date"]["month"],(int)jObject["forecast"]["simpleforecast"]["forecastday"][2]["date"]["day"]),  // simpleforecast / forecastday / date / year, month, day
                        ...
                        new Forecast()
                        {
                            ...
                            ObservationTime = new DateTime((int)jObject["forecast"]["simpleforecast"]["forecastday"][3]["date"]["year"],(int)jObject["forecast"]["simpleforecast"]["forecastday"][3]["date"]["month"],(int)jObject["forecast"]["simpleforecast"]["forecastday"][3]["date"]["day"]),  // simpleforecast / forecastday / date / year, month, day
